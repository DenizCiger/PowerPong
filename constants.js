...
export const BALL_SPEED = 300; // Converted for Phaser physics system (pixels per second)
export const PADDLE_SPEED = 6; // Paddle speed per frame for smooth movement
...
export const BALL_ACCELERATION = 20; // Ball acceleration for Phaser physics system
export const MAX_BALL_SPEED = 800; // Maximum ball speed for Phaser physics system
